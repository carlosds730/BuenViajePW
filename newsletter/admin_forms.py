...
class SubscriptionAdminForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        tmp = cleaned_data['newsletter'].subscription_set.filter(email_field=cleaned_data.get('email_field', None))
        if tmp.__len__():
            raise forms.ValidationError(_('This email is already subscribed to ' + cleaned_data['newsletter'].title))
